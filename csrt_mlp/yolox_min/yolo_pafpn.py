"""Minimal copy of YOLOX's YOLOPAFPN neck (key-compatible with yolox_*.pth)."""
...
class YOLOPAFPN(nn.Module):
    """CSPDarknet + PAFPN.  Returns (pan_out2, pan_out1, pan_out0) at strides 8/16/32."""
    ...
    def __init__(self, depth=1.0, width=1.0, in_features=("dark3", "dark4", "dark5"),
        ...
        self.C3_p4 = CSPLayer(int(2 * in_channels[1] * width),
        ...
        self.C3_p3 = CSPLayer(int(2 * in_channels[0] * width),
