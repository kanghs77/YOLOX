"""Minimal copy of YOLOX network building blocks.

Module and parameter names match Megvii's YOLOX exactly so that the official
``yolox_m.pth`` checkpoint loads into these modules without any key remapping
beyond stripping the ``backbone.`` prefix.
"""
...
class Focus(nn.Module):
    """Focus width and height information into the channel space."""
